...
<body class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 antialiased">
 ...
 <div class="mx-auto w-12 h-12 bg-brand-600 rounded flex items-center justify-center mb-6">
 ...
 <div class="pt-2">
 <button type="submit"
 class="flex w-full justify-center rounded-md bg-brand-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-brand-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-colors">
 Create Account
 </button>
 </div>
 ...
 <a href="{{ route('login') }}"
 class="font-semibold leading-6 text-brand-600 hover:text-brand-500">Sign in</a>
 </p>
 </form>
 </div>
