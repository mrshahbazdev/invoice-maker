...
<div class="sm:flex sm:items-center sm:justify-between mb-8 gap-4">
    ...
    <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-2">
        ...
        <a href="{{ route('client.statement') }}"
            class="inline-flex items-center justify-center rounded-lg bg-brand-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-brand-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600">
...
<div class="mb-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 shadow-sm ring-1 ring-gray-900/5">
        ...
        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden shadow-inner">
            <div class="bg-gradient-to-r from-brand-400 to-brand-600 h-full rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(79,70,229,0.4)]"
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ \Illuminate\Support\Facades\URL::signedRoute('invoices.public.show', $invoice->id) }}"
                                    target="_blank"
                                    class="inline-flex items-center rounded-lg bg-brand-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-brand-500 transition-colors">
                                    View & Pay
                                </a>
                            </div>
                        </div>
