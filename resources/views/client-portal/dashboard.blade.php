                                                        ...
                                                        <tfoot class="bg-gray-50">
                                                            ...
                                                            <tr class="border-t border-gray-200">
                                                                <td colspan="3"
                                                                    ...
                                                                    Total</td>
                                                                <td
                                                                    class="px-3 py-3 text-right text-sm font-bold text-gray-900">
                ...
                <ul role="list" class="space-y-6">
                    @foreach($invoices->take(5) as $invoice)
                        <li class="relative flex gap-x-4">
                            <div
                                class="absolute left-0 top-0 flex w-6 justify-center {{ $loop->last ? 'h-6' : '-bottom-6' }}">
