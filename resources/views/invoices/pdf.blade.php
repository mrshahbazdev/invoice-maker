...
<body>
    <div class="container">
                        ...
                        <td style="text-align: {{ $metaAlign }};">
                            ...
                            <div style="display: inline-block; vertical-align: top; text-align: {{ $metaAlign }};">
                                ...
                                <div class="invoice-meta">
                                    ...
                                    <p><strong>{{ __('Date') }}:</strong> {{ $invoice->invoice_date->format('M d, Y') }}</p>
                                    <p><strong>{{ $invoice->isEstimate() ? __('Expiry Date') : __('Due Date') }}:</strong> {{ $invoice->due_date->format('M d, Y') }}</p>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="addresses-wrapper">
            <div class="address-box left">
                ...
                <div class="address-content">
                    ...
                    @if($invoice->business->tax_number)<p>Tax ID: {{ $invoice->business->tax_number }}</p>@endif
                </div>
            </div>
            <div class="address-box right">
                ...
                <div class="address-content">
                    ...
                    @if($invoice->client->tax_number)<p>Tax #: {{ $invoice->client->tax_number }}</p>@endif
                </div>
            </div>
            <div class="clear"></div>
        </div>
            ...
            <div class="terms-box">
                @if($paymentTerms)
                    <div style="margin-bottom: 20px;">
                        <span class="address-label" style="color: {{ $primaryColor }};">Payment Terms</span>
        ...
        <div class="footer">
            <p>{{ $footerMessage }}</p>
            <p style="margin-top: 5px; opacity: 0.5;">Generated by InvoiceMaker on {{ now()->format('M d, Y') }}</p>
        </div>
    </div>
</body>
</html>
