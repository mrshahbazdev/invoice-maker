            ...
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <a href="{{ url('/') }}" class="flex-shrink-0 flex items-center">
                        ...
                        @else
                            <span
                                class="text-2xl font-extrabold text-blue-600 tracking-tight">{{ \App\Models\Setting::get('site.name', config('app.name')) }}</span>
                        @endif
                    </a>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('register') }}"
                        class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-sm">Get
                        Started</a>
                </div>
            </div>
        </div>
