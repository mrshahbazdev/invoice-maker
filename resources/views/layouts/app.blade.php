...
<body
 class="bg-brand-600 text-gray-800 antialiased font-sans flex flex-col min-h-screen"
 ...
 class="mr-3 text-gray-500 hover:text-brand-600 focus:outline-none lg:hidden flex-shrink-0 p-1 rounded-lg hover:bg-gray-100 transition-colors">
 ...
 @endif
 <h1
 class="text-lg sm:text-2xl font-bold text-brand-600 truncate pr-2">
 {{ $title ?? __('Dashboard') }}
 </h1>
 </div>
 ...
 class="flex items-center text-xs sm:text-sm text-gray-600 hover:text-brand-600 focus:outline-none transition-colors border border-gray-200 px-2 py-1 rounded-md bg-white sm:bg-transparent">
 ...
 class="block px-4 py-2 text-sm text-gray-700 hover:bg-brand-50 hover:text-brand-700 @if(app()->getLocale() == $code) font-bold bg-gray-50 @endif">
 {{ $name }}
 </a>
 @endforeach
 </div>
 ...
 class="flex items-center text-xs sm:text-sm text-gray-600 hover:text-brand-600 focus:outline-none transition-colors px-2 py-1.5 rounded-md hover:bg-gray-100 font-medium">
