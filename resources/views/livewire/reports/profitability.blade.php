        ...
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="relative w-full md:w-80 group">
                ...
                <input type="text" wire:model.live.debounce.300ms="search"
                    ...
                    class="block w-full pl-11 pr-10 py-4 bg-white border-2 border-gray-100 rounded-2xl text-base font-bold text-gray-800 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all placeholder:text-gray-400">

                @endif
            </div>

            <!-- Date Range -->
            <div class="flex items-center gap-4 bg-white px-5 py-3 rounded-2xl shadow-sm border-2 border-gray-100 w-full md:w-auto">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div
        ...
        <div>
            <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Total Expenses') }}</span>
