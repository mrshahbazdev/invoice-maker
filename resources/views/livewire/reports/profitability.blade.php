...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
            class="bg-white p-6 rounded-2xl border border-gray-100 flex items-center group transition-all duration-300 shadow-sm hover:border-blue-200">
            <div
                class="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center mr-4 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
        ...
        <div class="bg-blue-50/50 rounded-2xl p-5 border border-blue-100/50">
            ...
            <div class="space-y-2">
                @forelse($topClients as $client)
                    <div
                        class="bg-white px-4 py-2.5 rounded-xl flex items-center justify-between shadow-sm border border-blue-50/50">
                        <div class="flex items-center gap-3">
                            <span
                                class="w-5 h-5 rounded bg-blue-600 text-white text-[9px] flex items-center justify-center font-bold">{{ $loop->iteration }}</span>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @foreach($clientProfitability as $client)
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                <td class="px-6 py-4">
                                    <span
                                        class="text-sm font-bold text-gray-800 group-hover:text-blue-600 transition-colors">{{ $client['name'] }}</span>
                                </td>
