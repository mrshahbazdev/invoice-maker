@php $title = 'Create Estimate'; @endphp
...
<div>
                            ...
                            <div
                                ...
                                @foreach($this->products as $product)
                                    <button wire:click="selectProduct({{ $product->id }})"
                                        ...
                                        <div class="text-sm text-gray-500">{{ $this->currency_symbol }}{{ number_format((float) $product->price, 2) }} /
                                            {{ $product->unit }}
                                        </div>
                                    </button>
                                @endforeach
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="px-3 py-2 bg-gray-100 rounded-lg text-sm font-medium">
                                        {{ $this->currency_symbol }}{{ number_format((float) $item['total'], 2) }}</div>
                                </div>
                            </div>
                        </div>
                    @empty
    ...
    @if($step === 3)
        <div x-transition>
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Estimate Details</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <textarea wire:model="notes" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            placeholder="Terms, thank you note, etc..."></textarea>
                    </div>
                    <div>
    ...
    @if($step === 4)
        <div x-transition>
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Review Estimate</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between py-2 border-b">
                        <span class="font-medium">Estimate Date:</span>
