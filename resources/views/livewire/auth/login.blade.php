<div>
 ...
 <h1 class="text-2xl font-bold text-txmain">{{ __('Welcome Back') }}</h1>
 <p class="text-txmain mt-2">{{ __('Sign in to your account') }}</p>
 </div>
 ...
 <span class="ml-2 text-sm text-txmain">{{ __('Remember me') }}</span>
 </label>
 ...
 class="text-brand-600 hover:text-brand-700 font-medium">{{ __('Sign up') }}</a>
 </p>
 </div>
