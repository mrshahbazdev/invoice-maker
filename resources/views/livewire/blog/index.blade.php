    ...
    <div class="relative bg-white pt-24 pb-12 lg:pt-32 border-b border-gray-100 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight mb-6">
                @if($category)
                    Articles in <span
                        class="text-blue-600">{{ App\Models\Category::where('slug', $category)->value('name') }}</span>
                @else
                    Insights & Updates
                @endif
            </h1>
                    ...
                    <article
                        ...
                        <div class="flex-1 p-8 flex flex-col justify-between">
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-50 flex items-center justify-between">
                                <a href="{{ route('public.blog.show', $post->slug) }}"
                                    class="text-blue-600 font-semibold text-sm inline-flex items-center group-hover:text-blue-800 transition-colors">
                                    Read Article
