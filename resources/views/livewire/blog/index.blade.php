<div class="bg-gray-50 min-h-screen pb-20">
 ...
 Discover the latest strategies, tips, and news to accelerate your business growth and master your
 finances.
 </p>
 </div>
 </div>
 ...
 <div class="flex-1">
 <div class="flex items-center text-xs font-semibold tracking-wide text-gray-400 mb-4 uppercase">
 ...
 <a href="{{ route('public.blog.show', $post->slug) }}"
 class="text-brand-600 font-semibold text-sm inline-flex items-center group-hover:text-brand-800 transition-colors">
 Read Article
 ...
 @else
 We haven't published any articles yet. Check back soon for exciting updates and guides!
 @endif
 </p>
 @if($category)
 <div class="mt-8">
 <a href="{{ route('public.blog.index') }}"
 class="inline-flex items-center px-6 py-3 border border-transparent text-sm font-bold rounded-xl text-white bg-gray-900 hover:bg-gray-800 transition-colors shadow-sm">
 Clear Filters
 </a>
 </div>
 @endif
 ...
 <div class="absolute inset-0 z-0">
 <div class="absolute inset-0 bg-brand-600 opacity-90"></div>
 <div
 class="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 rounded-full bg-brand-500 mix-blend-multiply opacity-20 filter blur-3xl">
 </div>
 </div>
 <div class="relative z-10 max-w-3xl mx-auto">
 <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-6 tracking-tight">Ready to
 transform your invoicing?</h2>
 <p class="text-lg text-gray-300 mb-10 max-w-2xl mx-auto">Join thousands of professionals using our
