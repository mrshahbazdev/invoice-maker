<div class="bg-card min-h-screen pb-24">
 ...
 class="inline-block mb-6 text-xs font-bold tracking-widest text-brand-600 uppercase border border-brand-200 bg-brand-50 px-3 py-1 rounded-full hover:bg-brand-100 transition-colors">
 {{ $post->category->name }}
 </a>
 @endif
