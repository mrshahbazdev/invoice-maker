@php $title = __('Edit Product'); @endphp

<div>
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900">{{ __('Edit Product') }}</h2>
        <p class="text-gray-600">{{ __('Update product information') }}</p>
    </div>
        ...
        <form wire:submit="save" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                ...
                @if($manage_stock)
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <label
                            class="block text-sm font-medium text-gray-700 mb-1">{{ __('Current Stock Quantity') }}</label>
            ...
            <div class="flex justify-between">
                ...
                <button type="submit" wire:loading.attr="disabled"
                    class="inline-flex items-center bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition duration-200 disabled:opacity-50">
