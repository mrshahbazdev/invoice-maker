...
<div>
 <div class="mb-8">
 <h2 class="text-2xl font-bold text-txmain">{{ __('Edit Product') }}</h2>
 <p class="text-txmain">{{ __('Update product information') }}</p>
 </div>
 ...
 <label
 class="block text-sm font-medium text-txmain mb-1">{{ __('Current Stock Quantity') }}</label>
