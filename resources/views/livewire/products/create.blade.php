@php $title = 'Create Product'; @endphp

<div>
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900">Create Product</h2>
        <p class="text-gray-600">Add a new product to your library</p>
    </div>
        ...
        <form wire:submit="save" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <h4 class="text-sm font-semibold text-gray-900">Inventory Management</h4>
                        <p class="text-xs text-gray-500">Track stock levels and get warnings when low</p>
                    </div>
