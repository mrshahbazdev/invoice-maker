<div>
 ...
 <h2 class="text-2xl font-semibold text-txmain dark:text-gray-200">
 {{ __('Theme Palettes') }}
 </h2>
 ...
 <div class="bg-card dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
 <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
 <thead class="bg-page dark:bg-gray-700">
 <tr>
 <th scope="col"
 ...
 <tr>
 <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-txmain dark:text-gray-100">
 {{ $theme->name }}
 </td>
 ...
 <div
 class="inline-block align-bottom bg-card dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
 <form wire:submit.prevent="save">
 <div class="bg-card dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
 <h3 class="text-lg leading-6 font-medium text-txmain dark:text-gray-100 mb-4"
 id="modal-title">
 ...
 <div>
 <label for="name"
 class="block text-sm font-medium text-txmain dark:text-gray-300">{{ __('Name') }}</label>
 ...
 class="block text-sm font-medium text-txmain dark:text-gray-300">{{ __('Primary Color (Hex)') }}</label>
 <div class="mt-1 flex rounded-md shadow-sm">
 <input type="color" wire:model="primary_color"
 class="h-10 w-10 p-1 border border-r-0 border-gray-300 dark:border-gray-600 rounded-l-md bg-card dark:bg-gray-700 cursor-pointer">
 ...
 <label for="is_active"
 class="font-medium text-txmain dark:text-gray-300">{{ __('Enabled') }}</label>
 ...
 <div class="bg-page dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
 <button type="submit"
 ...
 class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-500 shadow-sm px-4 py-2 bg-card dark:bg-gray-800 text-base font-medium text-txmain dark:text-gray-300 hover:bg-page dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
 {{ __('Cancel') }}
 </button>
 </div>
 </form>
