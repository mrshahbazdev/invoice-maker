            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input wire:model="openai_api_key" type="password" placeholder="sk-..."
                        class="w-full bg-gray-900 border border-gray-700 rounded-lg text-white px-3 py-2 font-mono text-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <textarea wire:model="invoice_description_prompt" rows="3"
                        class="w-full bg-gray-900 border border-gray-700 rounded-lg text-gray-300 px-3 py-2 text-sm focus:ring-indigo-500 focus:border-indigo-500"></textarea>
