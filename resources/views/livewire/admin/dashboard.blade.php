<div class="space-y-6">
 ...
 <div
 class="absolute -bottom-4 -right-4 w-24 h-24 bg-brand-600 rounded-full blur-2xl z-0">
 </div>
 </div>
 ...
 <div
 class="h-10 w-10 rounded-full bg-brand-600 flex items-center justify-center text-white font-bold uppercase shadow-inner">
