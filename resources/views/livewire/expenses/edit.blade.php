@php $title = 'Edit Expense'; @endphp

<div>
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Edit Expense</h2>
            <p class="text-gray-600">Update your expense details</p>
        </div>
        <a href="{{ route('expenses.index') }}" class="text-gray-600 hover:text-gray-900">Back to List</a>
    </div>
            ...
            <form wire:submit="save">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" wire:model="category" list="categories"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="e.g. Travel, Office Supplies, Software">
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Replace Receipt (Optional)</label>
                    <div
                        class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                        <div class="space-y-1 text-center">
                            @if ($receipt)
                                <div class="mb-4">
                                    <p class="text-xs text-gray-500 mb-1 caps">Preview New:</p>
                                    <img src="{{ $receipt->temporaryUrl() }}"
                                        class="mx-auto h-32 w-auto rounded-lg shadow-sm border">
                                </div>
                            @elseif ($expense->receipt_path)
                                <div class="mb-4">
                                    <p class="text-xs text-gray-500 mb-1 caps">Current Receipt:</p>
