...
<div>
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600">Track and manage your business expenditures</p>
        </div>
                                ...
                                <div class="flex justify-end gap-3">
                                    @if($expense->receipt_path)
                                        <a href="{{ Storage::url($expense->receipt_path) }}" target="_blank"
                                            class="text-blue-600 hover:text-blue-700 text-sm font-medium" title="View Receipt">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-8 text-center text-gray-500">
                                No expenses recorded yet. <a href="{{ route('expenses.create') }}"
                                    class="text-blue-600 hover:text-blue-700">Record your first expense</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
