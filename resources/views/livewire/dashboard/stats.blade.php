<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ auth()->user()->business->currency_symbol }}{{ number_format($totalInvoiced, 2) }}</p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-gray-500">{{ $totalInvoices }} invoices</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ auth()->user()->business->currency_symbol }}{{ number_format($totalPaid, 2) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-600">{{ auth()->user()->business->currency_symbol }}{{ number_format($totalOutstanding, 2) }}</p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-orange-600 font-medium">{{ $overdueInvoices }} overdue</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <div class="mt-4 flex items-center text-sm">
                <a href="#" class="text-purple-600 hover:text-purple-700">View all clients &rarr;</a>
            </div>
        </div>
    </div>
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                    ...
                    <div class="text-right">
                        <p class="font-medium text-gray-900">{{ auth()->user()->business->currency_symbol }}{{ number_format($invoice->total, 2) }}</p>
                ...
                @empty
                <div class="p-8 text-center text-gray-500">No invoices yet</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                    ...
                    <div class="text-right">
                        <p class="font-medium text-green-600">+{{ auth()->user()->business->currency_symbol }}{{ number_format($payment->amount, 2) }}</p>
                        <p class="text-xs text-gray-500">{{ ucfirst($payment->payment_method) }}</p>
                    </div>
                </div>
                @empty
                <div class="p-8 text-center text-gray-500">No payments yet</div>
                @endforelse
            </div>
        </div>
    </div>
