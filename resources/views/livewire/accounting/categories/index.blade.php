        ...
        <table class="w-full">
            <thead>
                <tr class="border-b bg-gray-50">
                    ...
                    <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">{{ __('Account') }}</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($categories as $category)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-3 px-4 text-gray-600 text-sm font-mono">{{ $category->booking_account ?: '-' }}</td>
                        <td class="py-3 px-4">
                            <span
                ...
                <form wire:submit="save" class="flex flex-col flex-1 overflow-hidden">
                    ...
                    <div class="p-6 bg-gray-50 border-t flex justify-end gap-3">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="inline-flex items-center px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-sm transition font-bold disabled:opacity-50">
