...
<div>
 ...
 <!-- Balance Card -->
 <div
 class="px-6 py-5 flex items-center group bg-brand-600 relative overflow-hidden">
 ...
 @if($aiInsights)
 <div
 class="mb-8 p-6 bg-brand-600 border border-brand-100 rounded-2xl shadow-sm relative overflow-hidden">
