        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div>
                <div class="flex items-center text-sm text-gray-500 mb-2">
                    <a href="{{ route('client.tickets.index') }}" class="hover:text-indigo-600 transition-colors">Support Tickets</a>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="space-y-6">
                @foreach($replies as $reply)
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border {{ $reply->user->is_super_admin ? 'border-indigo-200' : 'border-gray-200' }}">
                        <div class="p-6">
                                    ...
                                    <div>
                                        <div class="font-bold text-gray-900 flex items-center gap-2">
                                            ...
                                            @if($reply->user->is_super_admin)
                                                <span class="px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 text-xs font-medium">Support Team</span>
                                            @endif
                                        </div>
                            ...
                            @if($reply->attachment_path)
                                <div class="mt-4 pt-4 border-t border-gray-100">
                                    ...
                                    <a href="{{ Storage::url($reply->attachment_path) }}" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-gray-50 border-t border-gray-200">
                    ...
                    <form wire:submit.prevent="reply" class="space-y-4">
                        ...
                        <div>
                            <textarea wire:model.defer="message" rows="4" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Type your reply here..."></textarea>
                        ...
                        <div>
                            <div class="flex items-center" x-data="{ fileName: '' }">
                                ...
                                <div wire:loading wire:target="attachment" class="ml-3 text-sm text-indigo-500">
                                    Uploading...
                                </div>
                            </div>
