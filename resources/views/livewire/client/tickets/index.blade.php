<div>
 ...
 <a href="{{ route('client.tickets.show', $ticket) }}" class="text-brand-600 hover:text-brand-900 bg-brand-50 hover:bg-brand-100 px-3 py-1 rounded-md transition-colors">View</a>
 </td>
 </tr>
 @endforeach
 </tbody>
