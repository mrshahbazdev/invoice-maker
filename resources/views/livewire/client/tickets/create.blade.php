<div>
 ...
 <div class="p-8 bg-card border-b border-gray-200">

 <form wire:submit.prevent="createTicket" class="space-y-6">

 <!-- Subject -->
 <div>
 <label for="subject" class="block text-sm font-medium text-txmain">Subject <span
 ...
 <!-- Category -->
 <div>
 <label for="category" class="block text-sm font-medium text-txmain">Category <span
 class="text-red-500">*</span></label>
 ...
 <!-- Priority -->
 <div>
 <label for="priority" class="block text-sm font-medium text-txmain">Priority <span
 class="text-red-500">*</span></label>
 ...
 <!-- Message -->
 <div>
 <label for="message" class="block text-sm font-medium text-txmain">Message <span
 class="text-red-500">*</span></label>
 ...
 <!-- File Upload -->
 <div>
 <label for="attachment" class="block text-sm font-medium text-txmain">Attachment
 (Optional)</label>
 ...
 <a href="{{ route('client.tickets.index') }}"
 class="text-txmain hover:text-txmain font-medium text-sm transition-colors">Cancel</a>
 <button type="submit"
